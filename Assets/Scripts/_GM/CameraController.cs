...
public class CameraController : MonoBehaviour {
	...
	public float firstPersoneDistance;			// Distance desired to trigger first person mode
    ...
    public float rotationDampening = 3.0f;      // Auto Ration Speed (higher = faster)
    ...
    void Update()
    {
        ...
        if (desiredDistance == firstPersoneDistance)
        {
